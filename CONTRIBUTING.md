...
2. **쉬운 것부터** — [`good first issue`](https://github.com/baboplater-blip/lingua-loop/labels/good%20first%20issue) 라벨이 붙은 이슈가 진입점입니다. 그중 **언어팩 기여**(🌍)는 코어 코드 0줄로 시작할 수 있어 가장 추천합니다 — 단계별 가이드: [`docs/ADD_LANGUAGE.md`](docs/ADD_LANGUAGE.md)(규칙 11).
