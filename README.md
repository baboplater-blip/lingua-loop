...
자세히: [`docs/SELF_HOSTING.md`](docs/SELF_HOSTING.md) · 운영 루프: [`docs/OPERATING.md`](docs/OPERATING.md) · 기여: [`CONTRIBUTING.md`](CONTRIBUTING.md) · 투명성: [`docs/DATA_CARD.md`](docs/DATA_CARD.md) · [`docs/MODEL_CARD.md`](docs/MODEL_CARD.md) · 보안·인증: [`SECURITY.md`](SECURITY.md) · 알려진 한계: [`docs/KNOWN_LIMITATIONS.md`](docs/KNOWN_LIMITATIONS.md).
